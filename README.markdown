...
* Well tested - over 500 unit tests.
...
It returns a function - a new instance of httpinvoke, with hooks copied from the parent httpinvoke and the current one added.
